...
HD_PWD='C:/Users/zgnhz/Desktop/graduatedesign/dds/dds.runs/squ_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log squ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source squ.tcl
