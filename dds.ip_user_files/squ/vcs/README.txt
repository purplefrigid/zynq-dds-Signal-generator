...
#
# Generated by export_simulation on Sat May 13 23:25:27 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './squ.sh' script.
...
./squ.sh -noclean_files

For more information on the script, please type './squ.sh -help'.
